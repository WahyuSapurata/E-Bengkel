            ...
            <form id="form" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <label class="text-capitalize form-label">tgl beli</label>
                            <input type="text" name="tgl_beli" id="tgl_beli" class="form-control dateofBirth">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="mb-2">
