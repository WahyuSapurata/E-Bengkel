                                ...
                                <table style="width: 100%" id="dataTables" class="table table-hover mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-capitalize">outlet</th>
            ...
            <form id="form">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-2">
                            <label class="text-capitalize form-label">po outlet</label>
                            <select name="uuid_po_outlet" id="uuid_po_outlet" data-placeholder="Pilih inputan"
                        ...
                        <div class="mb-2">
                            <label class="text-capitalize form-label">tanggal kirim</label>
                            <input type="text" name="tanggal_kirim" id="tanggal_kirim"
                            ...
                            <div class="row mb-2 produk-row">
                                <div class="col-6">
                                    ...
                                    <select name="uuid_produk[]" id="uuid_produk" data-placeholder="Pilih inputan"
                                        ...
                                        @foreach ($produk as $p)
                                            <option value=""></option>
                                            <option value="{{ $p->uuid }}">{{ $p->nama_barang }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-6">
...
@push('scripts')
    <script>
        ...
        $('#form').on('submit', function(e) {
            ...
            let updateUrl = `{{ route('superadmin.pengiriman-update', ':uuid') }}`;
            updateUrl = updateUrl.replace(':uuid', uuid);

            let url = uuid ? updateUrl :
                `{{ route('superadmin.pengiriman-store') }}`;
        ...
        $('#dataTables').on('click', '.edit', function() {
            ...
            let editUrl = `{{ route('superadmin.pengiriman-edit', ':uuid') }}`;
        ...
        $('#dataTables').on('click', '.delete', function() {
            let uuid = $(this).data('uuid');
            let deleteUrl = `{{ route('superadmin.pengiriman-delete', ':uuid') }}`;
        ...
        const initDatatable = () => {
            ...
            $('#dataTables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('superadmin.pengiriman-get') }}",
                columns: [{
                        data: null,
