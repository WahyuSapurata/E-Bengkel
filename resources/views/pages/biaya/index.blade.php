            ...
            <form id="form">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-2">
                            <label for="uuid_coa" class="form-label text-capitalize">Akun</label>
                            <select name="uuid_coa" id="uuid_coa" data-placeholder="Pilih inputan"
                        ...
                        <div class="mb-2">
                            <label class="text-capitalize form-label">jumlah</label>
...
@push('scripts')
    <script>
        ...
        $('#form').on('submit', function(e) {
            ...
            let updateUrl = `{{ route('superadmin.biaya-update', ':uuid') }}`;
            updateUrl = updateUrl.replace(':uuid', uuid);

            let url = uuid ? updateUrl :
                `{{ route('superadmin.biaya-store') }}`;
        ...
        $('#dataTables').on('click', '.edit', function() {
            ...
            let editUrl = `{{ route('superadmin.biaya-edit', ':uuid') }}`;
            ...
            $.get(editUrl, function(res) {
                $.each(res, function(key, value) {
                    ...
                    if (key === 'jumlah') {
                        // Kalau jumlah, format ke Rupiah saat set value
        ...
        $('#dataTables').on('click', '.delete', function() {
            let uuid = $(this).data('uuid');
            let deleteUrl = `{{ route('superadmin.biaya-delete', ':uuid') }}`;
        ...
        const initDatatable = () => {
            ...
            $('#dataTables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('superadmin.biaya-get') }}",
                columns: [{
                        data: null,
