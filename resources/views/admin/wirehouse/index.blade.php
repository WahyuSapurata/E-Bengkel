                                ...
                                <table style="width: 100%" id="dataTables" class="table table-hover mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-capitalize">nama outlet</th>
            ...
            <form id="form">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-2">
                            <label class="text-capitalize form-label">nama outlet</label>
                        ...
                        <div class="mb-2">
                            <label class="text-capitalize form-label">lokasi</label>
                            <select name="lokasi" id="lokasi" data-placeholder="Pilih inputan"
                                class="form-select basic-usage">
                                <option value=""></option>
                        ...
                        <div class="mb-2">
                            ...
                            <textarea name="keterangan" id="keterangan" placeholder="Gudang/Toko outlet CP PALLANGGA" class="form-control"
...
@push('scripts')
    <script>
        ...
        $('#form').on('submit', function(e) {
            ...
            let updateUrl = `{{ route('superadmin.wirehouse-update', ':uuid') }}`;
        ...
        $('#dataTables').on('click', '.edit', function() {
            ...
            let editUrl = `{{ route('superadmin.wirehouse-edit', ':uuid') }}`;
        ...
        $('#dataTables').on('click', '.delete', function() {
            let uuid = $(this).data('uuid');
            let deleteUrl = `{{ route('superadmin.wirehouse-delete', ':uuid') }}`;
        ...
        const initDatatable = () => {
            ...
            $('#dataTables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('superadmin.wirehouse-get') }}",
                columns: [{
                        data: null,
